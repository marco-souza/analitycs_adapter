...
var mixpanel_1 = __webpack_require__(3);
/**
...
var AnalyticsAdapter = (function () {
    function AnalyticsAdapter(eng, tk) {
        if (tk === void 0) { tk = ""; }
        ...
        switch (eng) {
            case "mixpanel":
                if (tk == "")
                    throw ("You need a token!");
                this.engine = new mixpanel_1["default"](tk);
                break;
            case "":
                this.engine = new mock_1["default"]();
                break;
            default:
     ...
     */
    AnalyticsAdapter.prototype.identify = function (userId, previous_identified) {
        if (previous_identified === void 0) { previous_identified = false; }
        if (!userId)
            throw "Empty userId!";
     ...
     */
    AnalyticsAdapter.prototype.track = function (event, props) {
...
var Mock = (function () {
    ...
    Mock.prototype.identify = function (userId) {
        // Find on a list of identifiers
        for (var i in this.mapIdentifiers) {
            if (i == userId) {
    ...
    Mock.prototype.alias = function (userId) {
        this.uniqIdentifier = utils_1.seededRand(this.seed++);
        this.customIdentifier = userId;
        // Save alias to a uniqIdentifier
        this.mapIdentifiers[userId] = this.uniqIdentifier;
    };
    Mock.prototype.track = function (ev, props) {
        var newEvent = __assign({ "event": ev }, props);
...
exports.__esModule = true;
function seededRand(seed, max, min) {
    if (max === void 0) { max = 1; }
    if (min === void 0) { min = 0; }
    if (!seed)
...
exports.__esModule = true;
var mixpanel_browser_1 = __webpack_require__(4);
/**
...
var Mixpanel = (function () {
    ...
    function Mixpanel(token) {
        this._eng = mixpanel_browser_1["default"];
    ...
    Mixpanel.prototype.getMixpanel = function () {
        return this._eng;
    };
    /**
     * @param  {number|string} userId
     */
    Mixpanel.prototype.alias = function (userId) {
        // Save alias to a uniqIdentifier
     ...
     * @param  {} props={}
     */
    Mixpanel.prototype.track = function (ev, props) {
        if (props === void 0) { props = {}; }
        // Track an event
